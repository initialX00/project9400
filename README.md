...
-   불편함이 크다고 알려진 맥도날드 키오스크를 개선하기 </br></br>
...
1. 팀원 간의 명확한 이미지 공유를 위해 figma와 front로 틀부터 잡는것을 목표로 했습니다.
2. 고객페이지는 하나의 흐름이라서 한명의 조원이 메인으로 담당하고 다른 조원들이 서포트하는 방식을 선택했습니다.
3. 관리자페이지는 각 페이지를 담당하여 분업했습니다.
4. 각 개인의 GitHub Issue를 생성합니다.
5. 작업을 완료하면 각자의 생성한 브랜치에서 코드를 push하여 Pull Requset합니다.
6. 팀장이 코드를 확인하고 Merge합니다.
